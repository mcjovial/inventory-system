            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-7">
                                        ...
                                        <tbody>
                                            @foreach($cart_products as $product)
                                                <tr>
                                                    ...
                                                    <form action="{{ route('admin.bulk.cart_update', $product->id) }}" method="post">
                                                        @csrf
                                                        {{-- @method('PUT') --}}
                                                        <td>
                        ...
                        <div class="card">
                            <form action="{{ route('admin.bulk.invoice') }}" method="post">
                                @csrf
                                <div class="card-header">
                                    <h3 class="card-title">
                                        Customer

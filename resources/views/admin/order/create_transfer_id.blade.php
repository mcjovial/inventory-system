                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form role="form" action="{{ route('admin.transfer.store') }}" method="post">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Amount</label>
                                                <input type="text" class="form-control" name="amount" value="{{ old('amount') }}" placeholder="Enter Amount Transfered">
                                            </div>
                                        </div>
                                    </div>
                                </div>
